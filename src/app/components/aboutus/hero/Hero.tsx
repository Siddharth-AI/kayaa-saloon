...
export default function Hero() {
  ...
  return (
    <div className="relative h-[20rem] md:h-[35rem] overflow-hidden">
      ...
      {/* Decorative elements */}
      <div className="absolute top-8 left-8 w-16 h-16 bg-gradient-to-br from-[#F28C8C]/20 to-[#C59D5F]/20 rounded-full animate-pulse"></div>
      <div className="absolute bottom-12 right-12 w-24 h-24 bg-gradient-to-br from-[#C59D5F]/15 to-[#F28C8C]/15 rounded-full animate-bounce"></div>
