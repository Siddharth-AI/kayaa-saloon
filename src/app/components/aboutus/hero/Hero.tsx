...
export default function Hero() {
  ...
  return (
    <div className="relative h-[14rem] md:h-[20rem] lg:h-[26rem] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-end md:justify-center items-center text-white z-30 pb-10 md:pb-0 md:mt-10">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="text-center">
          <p className="text-xs sm:text-xs md:text-sm lg:text-sm font-playfair italic mb-1 sm:mb-2 md:mb-3 text-pink-100 tracking-wide px-2">
            Enhancing Your Beauty for 20 Years
          </p>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-bold tracking-wider text-center font-playfair text-pink-50 drop-shadow-lg px-2">
            ABOUT KAYA
          </h1>
          <motion.div
            initial={{ width: 0 }}
            ...
            className="w-24 h-1 bg-gradient-to-r from-[#F28C8C] to-[#C59D5F] mx-auto mt-4 sm:mt-6 rounded-full"
          />
        </motion.div>
      </div>
    </div>
